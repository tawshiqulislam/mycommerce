...
class ShoppingCartController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $product = Product::select('id', 'name')
            ...
            ->first();
        return redirect()->back()->with('success', "Added to cart - $product->name");
        // return to_route('shopping-cart.index')->with('success', "Added to cart - $product->name");
    }
    ...
    public function destroy($skuId): RedirectResponse
    {
        ...
        return to_route('shopping-cart.index')->with('success', 'Product is removed from cart');
    }
}
