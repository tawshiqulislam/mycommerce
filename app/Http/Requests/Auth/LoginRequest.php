...
class LoginRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'otp' => ['required_if:otp_sent,true', 'numeric', 'digits:4'],
        ];
    }
    ...
    public function authenticate(): void
    {
        ...
        $user->points = User::where('referrer_code', $user->referral_code)->sum('referrer_points');
        $user->save();
    ...
    public function sendOtp()
    {
        ...
        Session::put('phone_number', (string) $otp);
