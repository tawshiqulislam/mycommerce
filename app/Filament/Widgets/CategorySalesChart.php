...
class CategorySalesChart extends ChartWidget
{
    ...
    protected static ?string $heading = 'Top 10 Categories';
    ...
    protected function getData(): array
    {
        ...
        $categories = Category::select('id', 'name')->withCount([
            'order_products' => function (Builder $query2) use ($filterMonth) {
        ...
        self::$heading = self::$heading . " (" . Number::format($categories->sum()) . " products sold)";
        return [
            'datasets' => [
                [
                    'label' => 'Orders',
