...
class OrderStatsOverview extends BaseWidget
{
    protected function getStats(): array
    {
        ...
        return [
            Stat::make('Orders in ' . now()->translatedFormat('F'), $orders->count())
                ->chart($chartSalesMonth),
            Stat::make('Total Revenue', Number::currency($orders->sum('total') ?: 0)),
            Stat::make('Average', Number::currency($orders->average('total') ?: 0)),
        ];
    }
}
