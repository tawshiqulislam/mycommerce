...
export default function LayoutBlog({
    ...
    const { filters, categories_blog, recent_post, page, banner } =
        usePage().props;
        ...
        <Layout>
            ...
            <div className="container ">
                {page && (
                    <Hero
                        title={page.title}
                        entry="Stay up to date with our latest news and updates!"
                    />
                )}
                    ...
                    <div className="flex flex-col xl:flex-row gap-10">
                        ...
                        <div className="w-full  xl:w-4/12 2xl:w-3/12">
                            <div className="divide-y divide-gray-200">
                                                ...
                                                <div className="flex items-start gap-x-4">
                                                    <div className="w-4/12">
                                                        <img
                                                            src={post.img}
                                                            alt={post.title}
                                                            className="rounded-md w-full object-cover object-center aspect-video "
                                                        />
                                                    </div>
                                                    <div className="w-8/12 ">
                                                        <span className="block text-gray-500 capitalize text-xs">
                                                            {post.date}
                                                        </span>
                                ...
                                {banner && (
                                    <div className="py-5">
                                        <a target="_blanck" href={banner.link}>
                                            <img
                                                src={banner.img}
                                                alt=""
