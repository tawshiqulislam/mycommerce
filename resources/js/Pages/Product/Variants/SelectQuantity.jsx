            ...
            <div>
                <div className="flex space-x-3 items-stretch mt-8">
                    <div className="flex items-center border border-gray-200 rounded-md divide-gray-200 divide-x bg-white  h-10">
                        ...
                        <span
                            id="countQuantity"
                            className=" flex items-center  h-full w-14 justify-center"
                        >
                            {form.data.quantity}
                        </span>
                        <button
                            ...
                            className="disabled:opacity-20 flex items-center px-4 h-full"
                        >
                    ...
                    <div className="flex items-center">
                        <span className=" text-sm font-light text-gray-400">
                            ( {selectedSkuSize ? selectedSkuSize.stock : 0}{" "}
                            Available )
                        </span>
                    </div>
                </div>
                <span className="text-xs text-gray-400">
                    Maximum per order: {maxQuantity}
                </span>
            </div>
        </>
    );
