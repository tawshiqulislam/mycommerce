                ...
                {optionsList.map((item, index) => (
                    <div key={index} className="flex items-center">
                        <input
                            ...
                            checked={optionsChecked.includes(
                                item.id.toString()
                            )}
                            type="checkbox"
                        ...
                        />
                        <label
                            className=" text-gray-600  flex items-center gap-x-2 cursor-pointer"
                            htmlFor={filterName + item.id}
                        >
                            {type == "color" && (
                                <span
                                    style={{
                                    ...
                                    aria-hidden="true"
                                    className="size-4 rounded-full  inline-block  border-gray-200"
                                ></span>
                            )}
