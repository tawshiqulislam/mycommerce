                ...
                <article className="py-content">
                    <div>
                        ...
                        <div className="uppercase text-gray-500 text-sm mt-8">
                            <time dateTime={post.created_at} className="">
                                {post.date}
                            </time>
                        </div>

                        <h1 className="mt-2 text-2xl md:text-4xl font-bold leading-tight tracking-tight text-gray-900 lg:text-4xl dark:text-white">
                            {post.title}
                        </h1>
                    ...
                    <p className="lead mt-8 text-xl font-medium md:text-2xl  text-gray-800">
                        {post.entry}
                    </p>
