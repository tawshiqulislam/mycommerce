...
Route::post('/store-google-user', [SocialiteController::class, 'storeGoogleUser']);

Route::get('login/facebook', [SocialiteController::class, 'redirectToFacebook'])->name('auth.facebook');
